...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int SYNC_SUNSHINE_HOUR = 3;
    private static final int SYNC_INTERVAL_SECONDS = (int) TimeUnit.HOURS.toSeconds(SYNC_SUNSHINE_HOUR);
    private static final int SYNC_FLEXTIME_SECONDS = SYNC_INTERVAL_SECONDS / 3;

    private static boolean sInitialized;

//  TODO (11) Add a sync tag to identify our sync job
    private static final String TAG_SYNC_JOB = "sunshine-sync";

//  TODO (12) Create a method to schedule our periodic weather sync
    public static void schedulePeriodicWeatherSync(final Context context) {
