...
//      TODO (7) Generate a weather summary with the date, description, high and low
        long dateMS = mCursor.getLong(MainActivity.INDEX_WEATHER_DATE);
        String dateString = SunshineDateUtils.getFriendlyDateString(mContext, dateMS, false);
        ...
        String weatherSummary = dateString + " - " + description + " _ " + highAndLowTemperature;
